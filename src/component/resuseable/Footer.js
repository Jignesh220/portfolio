...
export default function Footer() {
  return (
    <div>
      <div class="container-fluid text-center bg-theme fixed-bottom">
        <a
          className="text-danger t1 ms-2 me-2 fs-5"
        ...
        <a
          className="text-primary t1 ms-2 me-2 fs-5"
        ...
        <a
          className="ntext-dark t1 ms-2 me-2 fs-5"
